/*
  ...
  - You are about to drop the column `site_id` on the `posts` table. All the data in the column will be lost.
  - Added the required column `siteId` to the `posts` table without a default value. This is not possible if the table is not empty.
